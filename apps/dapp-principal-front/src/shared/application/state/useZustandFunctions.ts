import { Action } from "../types/stateTypes";

/* eslint-disable @typescript-eslint/no-explicit-any */
export const useZustandFunctions = <
  StoredActions,
  StateActions extends Partial<StoredActions>
>() => {
  type Actions<T> = Action<T, StoredActions>;
  /**
   ...
   */
  const setValue =
    <T = boolean, K extends keyof StateActions = keyof StateActions>(
      key: K
